...
mainSrvc.getUserFavs($scope.user.authid).then(res => {
    $scope.user_favs = res.data
    if($scope.user_favs.length < 1){
        $scope.favmessage = "None yet. Go to the voting page and favorite some dogs!";
    }
});
